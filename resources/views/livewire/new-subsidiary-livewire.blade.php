<div class="col-md-12 card shadow bg-white p-3">
    <div class="row">
        <div class="col-md-12">
            <button class="btn btn-principal" wire:click="newSubsidiary">Cancelar</button>
        </div>
    </div>
    <form>
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('contract_id')  is-invalid @enderror"
                        name="contract_id" value="{{$associated->contrato->name}}" aria-describedby="idHelp" readonly>
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    <label for="company_id" class="form-label">Associada</label>
                    <input type="text" class="form-control @error('company_id')  is-invalid @enderror" name="company_id"
                        value="{{$associated->name}}" aria-describedby="idHelp" readonly>
                    @error('company_id') <div id="company_idHelp" class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
            </div>
